...
<body class="d-flex justify-content-center p-4 pt-4">
    <div class="card">
        ...
        <div class="card-body">
            Hello <b>{{ request()->name }}</b>, thank you for joining the sons of ministers.</br>
            When your account is approved, you will receive your credentials on <b>{{ request()->email }}</b> </br>
            Thank you </br></br>
